...
\newcommand{\modul}{Partielle Differentialgleichungen}
\newcommand{\semester}{Sommersemester 2020}

%\renewcommand{\tutor}{TUTOR}
%\renewcommand{\gruppe}{Tag x. DS, (un)gerade Woche}

\newcommand{\professor}{Prof. Dr. Friedemann Schuricht}
\newcommand{\fakultaet}{Mathematik}
\newcommand{\institut}{Geometrie}
\newcommand{\lehrstuhl}{Nichtlineare Analysis}
...
\newcommand{\dsq}[1]{\left[\left[ #1 \right]\right]}
...
\include{pde-uebungen-1}
\include{pde-uebungen-2}
\include{pde-uebungen-3}
\include{pde-uebungen-4}
\include{pde-uebungen-5}
\include{pde-uebungen-6}
